...
import src.utils.cotta_transforms as my_transforms
from src.utils.inject_vida import inject_trainable_vida
...
def configure_model(model, cfg):
    ...
    vida_params, vida_names = inject_trainable_vida(model = model, target_replace_module = ["CrossAttention", "Attention"], \
            r = cfg.VIDA.vida_rank1, r2 = cfg.VIDA.vida_rank1)
    if cfg.VIDA.ckpt!=None:
